...
const objStateCache = new Map<string, ObjState>();
 ...
 * UV tiling/offset scaling, and PBR material controls.
 */
export const OBJECT_OBJ_NODE: NodeDefinition = {
  ...
  evaluate: (inputs, params, ctx) => {
    ...
    // Update material PBR properties, textures, and UV scaling on all meshes inside group
